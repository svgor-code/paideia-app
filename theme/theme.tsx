...
export const defaultPrimary = "#00868F";
export const defaultSecondary = "#FF8219";
export const defaultDarkPrimary = "#9FD2DB";
export const defaultDarkSecondary = "#FC9E4F";
...
export const LightTheme = (primary: string, secondary: string) => {
  return createTheme({
    ...mainTheme,
    palette: {
      circle: {
...
export const DarkTheme = (primary: string, secondary: string) => {
  return createTheme({
    ...mainTheme,
    palette: {
      mode: "dark",
